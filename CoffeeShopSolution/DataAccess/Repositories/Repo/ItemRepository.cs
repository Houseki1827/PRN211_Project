...
namespace DataAccess.Repositories.Repo {
    public class ItemRepository : IItemRepository {
        ...
        public void DeleteItem(int id) {
            ...
            if (GetItems().SingleOrDefault(i => i.ItemId.Equals(id)) == null) throw new Exception("Cannot find item to delete.");
            try {
        ...
        public Item? GetItemById(int id) => GetItems().SingleOrDefault(i => i.ItemId.Equals(id));
        ...
        public void UpdateItem(Item item) {
            if (item == null) throw new Exception("Input item is empty.");
                ...
                if (item.ItemName == null) throw new Exception("Item name must not be empty.");
                else if (item.CategoryId == null) throw new Exception("Item categoryId must not be empty.");
